...
public class TestSPHII : MonoBehaviour
{
    ...
    private int TOTAL_PARTICLES = 400;
    private int PARTICLES_PER_VOLUME = 400;   //how many particles are there in a unit of volume of water e.g. 100 particles to form 1m3 water
